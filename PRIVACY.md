...
- **Transcribed text.** Subtitle text (never timestamps, never video URLs) is sent **directly** to the translation provider you configured (an OpenAI-compatible endpoint or Anthropic).
