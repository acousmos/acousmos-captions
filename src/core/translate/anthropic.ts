...
function postMessages(body: Record<string, unknown>, opts: TranslateOptions): Promise<Response> {
  return fetchRetry(
    `${API}/messages`,
    {
      method: 'POST',
    ...
    { signal: opts.signal, timeoutMs: 120_000, retryStatuses: [408, 429, 500, 502, 503, 504, 529] },
  )
}
